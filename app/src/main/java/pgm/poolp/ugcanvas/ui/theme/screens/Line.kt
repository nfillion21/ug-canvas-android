    ...
    Canvas(modifier = Modifier.fillMaxSize()) {
        ...
        */
        ...
        drawLine(
            ...
            end = Offset(size.width - size.width * squareWidth * 0.5f, size.width * squareWidth * 1.5f),
            strokeWidth = size.width * 0.010f,
        )
        ...
        drawLine(
            Color.White,
            start = Offset(size.width - size.width * halfSquareWidth, size.width * halfSquareWidth),
